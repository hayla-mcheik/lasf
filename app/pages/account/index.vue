...
<div id="print-area">
        ...
        <div ref="frontCardRef" class="lasf-official-card front-side position-relative">
        ...
        <div ref="backCardRef" class="lasf-official-card lasf-official-cardtwo back-side text-start position-relative">
...
const downloadPdf = async () => {
    ...
    try {
        ...
        const response = await fetch(
            `${config.public.apiBase}/membership-card/download`,
            {
                method: "POST",
                headers: {
...
const generateQRCode = async () => {
  ...
  try {
    ...
    console.log('Generating QR Code for:', profileUrl)
...
onMounted(async () => {
  ...
  try {
    ...
    console.log('Membership data loaded:', membership.value)
